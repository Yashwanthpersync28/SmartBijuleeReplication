    ...
    <DrawerScreenWrapper >
      ...
      <View style={[{height:heightValue(1),width:widthValue(1)},styles.bglightblack]}>
       ...
       <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[{height:heightValue(6),width:widthValue(1.1)},styles.bgdashblue,marginPosition(13,0,50,20),styles.column,radius(15),padding(15),styles.selfStart]}>
             <View style={[styles.row]}>
              <Text style={[styles.white,fontSize(19)]}>Monthly</Text>
              <Text style={[styles.green,fontSize(19),marginPosition(0,0,0,5)]}>Comparison</Text>
             </View>
             <View style={[styles.column]}>
                  <Text style={[styles.white,marginPosition(5,0,5,5),fontSize(12)]}>December</Text>
                  <View style={[styles.row]}>
                  <View style={[{backgroundColor:"#3c3c42",height:heightValue(60),width:widthValue(1.6)},radius(20),marginPosition(0,0,5)]}></View>
                  <FontAwesome5Icon name='angle-left' style={[styles.green,fontSize(12),marginPosition(0,5,0,5)]}/>
                  <Text style={[styles.green,fontSize(12),marginPosition(-2)]}>0 Units</Text>
                  </View>
                
           </View>
           <View style={[styles.column]}>
               <Text style={[styles.white,marginPosition(0,0,5,5),fontSize(12)]}>November</Text>
               <View style={[styles.row]}>
                  <View style={[{backgroundColor:"#3c3c42",height:heightValue(60),width:widthValue(1.6)},radius(20),marginPosition(0,0,5)]}></View>
                  <Text style={[styles.white,fontSize(12),marginPosition(0,0,0,5)]}>0 Units</Text>
                  </View>
          </View>
    </View>
    </ScrollView>
