...
const MainCard = ({name,secondname,showsingleline,data,xaxis,yaxis}) => {
 ...
 const darkMode = useSelector((state)=>state.system.darkMode)
  ...
  return (
                <View style={[{height:heightValue(2),width:widthValue(1.1)},darkMode ? styles.bgWhite:styles.bgdashblue,radius(15),marginPosition('3%',0,0,'5%')]}>
    <View style={[{height:heightValue(18),width:widthValue(1.1)},styles.centerVertical]}>
         <View style={[styles.row,{marginLeft:widthValue(12)},styles.selfStart]}>
           <Text style={[darkMode?styles.black:styles.white,fontSize(20)]}>{name}</Text>
    ...
    <VictoryChart height={height / 2.2} domainPadding={{ x: 10 }} > 
                 <VictoryGroup offset={15} colorScale={[darkMode ? '#cfcccc' : '#3c3c42',darkMode ? '#cfcccc' : '#3c3c42']}>
                ...
                <VictoryAxis
                    style={{
                        ...
                        tickLabels: {
                            fill: darkMode ? 'black' : 'white', fontSize: 9
                        }
                    }}
                />
            </VictoryChart>
        ...
        <View style={[styles.white,styles.centerHorizontal,setmarginicon(showsingleline),marginPosition('3%')]}>
            ...
            <Text style={[darkMode?styles.black:styles.white,fontSize(10)]}>(Click on the chart to see the value)</Text>
        </View>
        <View style={[styles.white,styles.selfStart,styles.column,marginPosition(0,0,0,'8%')]}>
               <View style={[styles.row,setdisplay(showsingleline),styles.centerHorizontal]}>
                    ...
                    <Text style={[darkMode?styles.black:styles.white,fontSize(10),lineHeight(15),marginPosition(0,0,0,'3%')]}>Last Week Consumption (Units)</Text>
               </View>
               <View style={[styles.row,styles.centerHorizontal,marginPosition('-1%')]}>
