...
function Onboarding({heading,name,details,lottiedata,number}) {
  ...
  return (
    ...
    <View style={[{height:heightValue(1),width:widthValue(1)} ,styles.bglightblack]}>
       <View style={[marginPosition(50,0,0,40),screenWidth(1.2),flex(2.2)]}> 
           <Text style={[styles.green,fontSize(80),marginPosition(0,0,8,0)]}>{number}</Text>
           <Text style={[styles.white,fontSize(32),marginPosition(0,0,12,0)]}>{heading}</Text>
