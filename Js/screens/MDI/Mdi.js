...
const Mdi = ({navigation}) => {
 ...
 <View style={[{height:heightValue(1),width:widthValue(1)},styles.bglightblack]}>
  ...
  <View style={[{height:heightValue(20),width:widthValue(1)},styles.allCenter,marginPosition('2%')]}>
  <View style={[styles.bggreen,{width:widthValue(1.5),height:heightValue(35)},styles.allCenter,radius(15)]}>
    <Text style={[styles.white,fontSize(12)]}>(Click here ti view Current Month's MDI Chart)</Text>
  </View>
  </View>
  <View style={[{height:heightValue(5),width:widthValue(1)},styles.centerHorizontal,marginPosition('2%')]}>
    <View style={[styles.bgdashblue,{height:heightValue(7.2),width:widthValue(1.1)},radius(15)]}>
      <View style={[{height:heightValue(19),width:widthValue(1.1)},styles.row,styles.allCenter]}>
        <View style={[{height:heightValue(19),width:widthValue(1.3)},styles.row,styles.flexEnd]} >
        <Text style={[styles.white,fontSize(17)]}>Recorded</Text>
        <Text style={[styles.green,{marginLeft:widthValue(50)},fontSize(17)]}>Spike MD</Text>
      </View>
      </View>
  <View style={[{height:heightValue(19),width:widthValue(1.1)},styles.allCenter]}>

      <View style={[{height:heightValue(19),width:widthValue(1.3)},styles.row,styles.allCenter,styles.spaceBetween,borderWidth(0,0,0,0.8),borderColor('grey')]}>
      ...
      <View style={[{height:heightValue(28),width:widthValue(1.1)},styles.row,styles.allCenter]}>
       
        <Text style={[styles.green,fontSize(11)]}>A-MD-Assigned MD,P-MD-Peak MD</Text>
      </View>
