...
const Inputbox = ({name,onFocus,focuss,onBlur, onChangeText, id,showstar , keyboardType, inputvalueOTP}) => {
  return (
    <View style={[{height:heightValue(12),width:widthValue(1.6)},padding(0,10,20,10,20),styles.column,marginPosition(0,0,3),radius(20),bgColor(focuss)]}> 
      ...
      <TextInput keyboardType={keyboardType} style={[styles.white,borderWidth(0,0,0,1),borderColor('green'),marginPosition(0,0,15),fontSize(18),padding(0),{textAlignVertical:"center"}]} onBlur={onBlur} onFocus={onFocus} onChangeText={onChangeText} value={inputvalueOTP}/>
